                ...
                try {
                    ...
                    switch (receivedMsg.getType()) {
                        ...
                        case CHOKE:
                            ...
                            break;
                        case UNCHOKE:
                            System.out.println("Peer is UNCHOKING us! We can request pieces.");
                        ...
                        case BITFIELD:
                            ...
                            break;
                        case HAVE:
                            int pieceIndex = receivedMsg.getIndex();  // Define pieceIndex here
                            System.out.println("   Peer HAS piece " + pieceIndex);
                            peer.setPeerBitfield(pieceIndex);
                            if (!hasPiece(localBitfield, pieceIndex)) {
                                System.out.println("   We want piece " + pieceIndex + ". Sending INTERESTED");
