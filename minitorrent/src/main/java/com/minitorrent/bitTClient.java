                            ...
                            if (!hasPiece(localBitfield, pieceIndex)) {
                                ...
                                try {
                                    ...
                                    if (bytesRead < blockLength) {
                                        System.out.println("Warning: Expected to read " + blockLength + " bytes, but only read " + bytesRead);
                                    }
